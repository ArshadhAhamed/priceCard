  ...
  return <>
    ...
    <div className="card mb-5 mb-lg-0">
      <div className="card-body">
        ...
        <hr></hr>
        <ul className="fa-ul">
          <li className={data.isUsers?"":"text-muted"}><span className="fa-li"><i className={data.isUsers?"fas fa-check":"fas fa-times"}></i></span><strong>{data.users}</strong></li>
          ...
          <li className={data.isCommunityAcces?"":"text-muted"}><span className="fa-li"><i className={data.isCommunityAcces?"fas fa-check":"fas fa-times"}></i></span>{data.communityAcces}</li>
